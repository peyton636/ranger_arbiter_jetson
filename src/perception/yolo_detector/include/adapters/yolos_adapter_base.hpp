#ifndef ADAPTERS__YOLOS_ADAPTER_BASE_HPP
#define ADAPTERS__YOLOS_ADAPTER_BASE_HPP
...
namespace perception
{
  ...
  class PERCEPTION_YOLO_PUBLIC IYolosAdapterBase
  {
  public:
  ...
  class PERCEPTION_YOLO_PUBLIC IDetectorAdapter : public IYolosAdapterBase {
  public:
  ...
  class PERCEPTION_YOLO_PUBLIC ISegmentorAdapter : public IYolosAdapterBase {
  public:
  ...
  class PERCEPTION_YOLO_PUBLIC IPoseAdapter : public IYolosAdapterBase {
  public:
  ...
  class PERCEPTION_YOLO_PUBLIC IOBBAdapter : public IYolosAdapterBase {
  public:
  ...
  class PERCEPTION_YOLO_PUBLIC IClassifierAdapter : public IYolosAdapterBase {
  public:
...
#endif // ADAPTERS__YOLOS_ADAPTER_BASE_HPP