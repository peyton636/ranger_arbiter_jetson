#ifndef NODES__POSE_NODE_HPP_
#define NODES__POSE_NODE_HPP_
...
#include "adapters/pose_adapter.hpp"

namespace perception {

class PERCEPTION_YOLO_PUBLIC YolosPoseNode : public rclcpp_lifecycle::LifecycleNode {
public:
