#ifndef NODES__CLASSIFIER_NODE_HPP_
#define NODES__CLASSIFIER_NODE_HPP_
...
#include "adapters/classifier_adapter.hpp"

namespace perception
{

class PERCEPTION_YOLO_PUBLIC YolosClassifierNode : public rclcpp_lifecycle::LifecycleNode {
public:
...
private:
  ...
  rclcpp_lifecycle::LifecyclePublisher<vision_msgs::msg::Classification2D>::SharedPtr pub_;
