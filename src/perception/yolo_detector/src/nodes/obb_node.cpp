...
YolosOBBNode::CallbackReturn YolosOBBNode::on_configure(const rclcpp_lifecycle::State&) {
  ...
  pub_ = create_publisher<vision_msgs::msg::OBBDetection2DArray>("/perception/obb/detections", 10);
  if (debug_) dbg_ = create_publisher<sensor_msgs::msg::Image>("/perception/obb/debug_image", 1);
...
RCLCPP_COMPONENTS_REGISTER_NODE(perception::YolosOBBNode)
