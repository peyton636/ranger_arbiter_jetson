    ...
    YolosDetectorNode::CallbackReturn YolosDetectorNode::on_configure(const rclcpp_lifecycle::State &)
    {
        ...
        try
        {
            ...
            if (publish_debug_image_)
                debug_pub_ = create_publisher<sensor_msgs::msg::Image>("/perception/detect/debug_image", 1);
            if (publish_timing_)
                timing_pub_ = create_publisher<std_msgs::msg::Float64MultiArray>("/perception/detect/timing", 10);
