...
namespace perception
{
  ...
  FusionPoseNode::CallbackReturn FusionPoseNode::on_activate(const rclcpp_lifecycle::State &)
  {
    ...
    sync_ = std::make_shared<message_filters::Synchronizer<message_filters::sync_policies::ApproximateTime<
        DetectionArray, ImageMsg, CameraInfoMsg>>>(message_filters::sync_policies::ApproximateTime<
        DetectionArray, ImageMsg, CameraInfoMsg>(20), detections_sub_, depth_sub_, camera_info_sub_);
