...
from eth_gateway.blob_codec import encode_agv_control, encode_sensor_cfg, v3_command_to_blob
from eth_gateway.blob_time_stamp import time_sync_response_ros_stamp
from eth_gateway.blob_topic_pub import BlobTopicPublisher
from eth_gateway.blob_udp import EthBlobParser, EthRxItem, EthRxStats
from eth_gateway.jetson_protocol import UPLINK_TIMEOUT_MS
from eth_gateway.service_codec import payload_to_time_sync
from eth_gateway.service_frame import CAN_ID_TIME_SYNC_RSP
from eth_gateway.time_sync import CMD_START, JetsonTimeSync, mono_ms
...
class McuEthBridge:
    ...
    def __init__(
        ...
        *,
        ...
        self._link = UdpLink(
            bind_ip, local_port, mcu_ip, mcu_port, logger=self._logger.info
        )
    ...
    def declare_parameters(node: Node) -> None:
        node.declare_parameter("bind_ip", "0.0.0.0")
