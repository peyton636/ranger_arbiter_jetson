...
from agv_base_driver.chassis_fusion import build_feature_status, build_vehicle_data
from agv_base_driver.gps_fix import GpsFixHelper
...
class AgvBaseEthBringeNode(Node):
    ...
    def _publish_state(self) -> None:
        self._jetson_link_up = self._bridge.link_connected and self._bridge.link_uplink_up
